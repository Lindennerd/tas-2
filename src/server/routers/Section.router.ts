...
export const sectionsRouter = createRouter()
  ...
  .mutation("createOneSection", {
    ...
    async resolve({ ctx, input }) {
      const createOneSection = await ctx.prisma.section.create({
        data: input.data,
      });
  ...
  .mutation("deleteOneSection", {
    ...
    async resolve({ ctx, input }) {
      const deleteOneSection = await ctx.prisma.section.delete({
        where: input.where,
      });
  ...
  .query("findUniqueSection", {
    ...
    async resolve({ ctx, input }) {
      const findUniqueSection = await ctx.prisma.section.findUnique({
        where: input.where,
      });
  ...
  .query("groupBySection", {
    ...
    async resolve({ ctx, input }) {
      const groupBySection = await ctx.prisma.section.groupBy({
        where: input.where,
  ...
  .mutation("updateOneSection", {
    ...
    async resolve({ ctx, input }) {
      const updateOneSection = await ctx.prisma.section.update({
        where: input.where,
        data: input.data,
      });
  ...
  .mutation("upsertOneSection", {
    ...
    async resolve({ ctx, input }) {
      const upsertOneSection = await ctx.prisma.section.upsert({
        where: input.where,
        create: input.create,
        update: input.update,
      });
