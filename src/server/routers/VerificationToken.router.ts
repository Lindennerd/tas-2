  ...
  .mutation("createOneVerificationToken", {
    ...
    async resolve({ ctx, input }) {
      const createOneVerificationToken =
        await ctx.prisma.verificationToken.create({ data: input.data });
  ...
  .mutation("deleteOneVerificationToken", {
    ...
    async resolve({ ctx, input }) {
      const deleteOneVerificationToken =
        await ctx.prisma.verificationToken.delete({ where: input.where });
  ...
  .query("findUniqueVerificationToken", {
    ...
    async resolve({ ctx, input }) {
      const findUniqueVerificationToken =
        await ctx.prisma.verificationToken.findUnique({ where: input.where });
