...
const Schema: z.ZodType<Prisma.AssetUpdateUncheckedUpdateManyWithoutUserNestedInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const AssetUpdateUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
