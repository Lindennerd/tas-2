...
const Schema: z.ZodType<Prisma.AttachmentUpdateManyWithWhereWithoutManifestInput> =
  z
    .object({
...
export const AttachmentUpdateManyWithWhereWithoutManifestInputObjectSchema =
  Schema;
