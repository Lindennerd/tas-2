...
const Schema: z.ZodType<Prisma.QuestionUncheckedUpdateManyWithoutSectionNestedInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const QuestionUncheckedUpdateManyWithoutSectionNestedInputObjectSchema =
  Schema;
