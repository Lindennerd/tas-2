...
const Schema: z.ZodType<Prisma.CommentUncheckedCreateNestedManyWithoutAnswerInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const CommentUncheckedCreateNestedManyWithoutAnswerInputObjectSchema =
  Schema;
