...
const Schema: z.ZodType<Prisma.AnswerUpdateManyWithWhereWithoutManifestInput> =
  z
    .object({
...
export const AnswerUpdateManyWithWhereWithoutManifestInputObjectSchema = Schema;
