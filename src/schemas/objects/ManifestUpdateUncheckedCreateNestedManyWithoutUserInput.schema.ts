...
const Schema: z.ZodType<Prisma.ManifestUpdateUncheckedCreateNestedManyWithoutUserInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const ManifestUpdateUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
