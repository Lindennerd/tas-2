...
const Schema: z.ZodType<Prisma.AnswerUncheckedCreateNestedManyWithoutManifestInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const AnswerUncheckedCreateNestedManyWithoutManifestInputObjectSchema =
  Schema;
