...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutManifestUpdateInput> =
  z
    .object({
      id: z
        .union([
      ...
      Manifest: z
        .lazy(
          () => ManifestUncheckedUpdateManyWithoutUserNestedInputObjectSchema,
        )
        .optional(),
      Attachment: z
        .lazy(
      ...
      Comment: z
        .lazy(
          () => CommentUncheckedUpdateManyWithoutUserNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const UserUncheckedUpdateWithoutManifestUpdateInputObjectSchema = Schema;
