...
const Schema: z.ZodType<Prisma.AssetUpdateCreateNestedManyWithoutAssetInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const AssetUpdateCreateNestedManyWithoutAssetInputObjectSchema = Schema;
