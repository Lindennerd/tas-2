...
const Schema: z.ZodType<Prisma.ManifestUpdateUpdateManyWithoutManifestNestedInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const ManifestUpdateUpdateManyWithoutManifestNestedInputObjectSchema =
  Schema;
