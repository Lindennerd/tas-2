...
const Schema: z.ZodType<Prisma.ManifestUpdateUncheckedUpdateManyWithoutUserNestedInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const ManifestUpdateUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
