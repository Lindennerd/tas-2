...
const Schema: z.ZodType<Prisma.SectionUncheckedUpdateManyWithoutManifestNestedInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const SectionUncheckedUpdateManyWithoutManifestNestedInputObjectSchema =
  Schema;
