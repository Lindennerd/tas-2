...
const Schema: z.ZodType<Prisma.OptionUncheckedCreateNestedManyWithoutQuestionInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const OptionUncheckedCreateNestedManyWithoutQuestionInputObjectSchema =
  Schema;
