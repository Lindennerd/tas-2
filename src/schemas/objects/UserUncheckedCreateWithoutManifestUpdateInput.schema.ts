...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutManifestUpdateInput> =
  z
    .object({
      ...
      Manifest: z
        .lazy(
          () => ManifestUncheckedCreateNestedManyWithoutUserInputObjectSchema,
        )
        .optional(),
      Attachment: z
        .lazy(
...
export const UserUncheckedCreateWithoutManifestUpdateInputObjectSchema = Schema;
