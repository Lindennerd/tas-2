...
const Schema: z.ZodType<Prisma.AssetUpdateUncheckedUpdateManyWithoutAssetNestedInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const AssetUpdateUncheckedUpdateManyWithoutAssetNestedInputObjectSchema =
  Schema;
