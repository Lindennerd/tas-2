...
const Schema: z.ZodType<Prisma.ExtensionsUncheckedUpdateManyWithoutQuestionNestedInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const ExtensionsUncheckedUpdateManyWithoutQuestionNestedInputObjectSchema =
  Schema;
