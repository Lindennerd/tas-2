...
const Schema: z.ZodType<Prisma.CommentUpdateManyWithWhereWithoutAnswerInput> = z
  .object({
...
export const CommentUpdateManyWithWhereWithoutAnswerInputObjectSchema = Schema;
