...
const Schema: z.ZodType<Prisma.ManifestUncheckedCreateNestedManyWithoutUserInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const ManifestUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
