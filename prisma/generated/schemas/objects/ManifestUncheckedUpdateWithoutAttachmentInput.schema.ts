...
const Schema: z.ZodType<Prisma.ManifestUncheckedUpdateWithoutAttachmentInput> =
  z
    .object({
      id: z
        .union([
...
export const ManifestUncheckedUpdateWithoutAttachmentInputObjectSchema = Schema;
