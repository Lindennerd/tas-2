...
const Schema: z.ZodType<Prisma.AssetUpdateUncheckedCreateNestedManyWithoutUserInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const AssetUpdateUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
