...
const Schema: z.ZodType<Prisma.QuestionUncheckedCreateNestedManyWithoutSectionInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const QuestionUncheckedCreateNestedManyWithoutSectionInputObjectSchema =
  Schema;
