...
const Schema: z.ZodType<Prisma.AttachmentUncheckedCreateNestedManyWithoutUserInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const AttachmentUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
