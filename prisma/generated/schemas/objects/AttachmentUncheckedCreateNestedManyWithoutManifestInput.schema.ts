...
const Schema: z.ZodType<Prisma.AttachmentUncheckedCreateNestedManyWithoutManifestInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const AttachmentUncheckedCreateNestedManyWithoutManifestInputObjectSchema =
  Schema;
