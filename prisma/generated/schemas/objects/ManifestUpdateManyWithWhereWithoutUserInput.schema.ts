...
const Schema: z.ZodType<Prisma.ManifestUpdateManyWithWhereWithoutUserInput> = z
  .object({
...
export const ManifestUpdateManyWithWhereWithoutUserInputObjectSchema = Schema;
