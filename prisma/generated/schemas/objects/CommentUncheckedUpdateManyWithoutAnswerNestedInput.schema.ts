...
const Schema: z.ZodType<Prisma.CommentUncheckedUpdateManyWithoutAnswerNestedInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const CommentUncheckedUpdateManyWithoutAnswerNestedInputObjectSchema =
  Schema;
