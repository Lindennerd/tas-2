...
const Schema: z.ZodType<Prisma.ManifestUpdateUncheckedCreateNestedManyWithoutManifestInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const ManifestUpdateUncheckedCreateNestedManyWithoutManifestInputObjectSchema =
  Schema;
