...
const Schema: z.ZodType<Prisma.SectionUncheckedCreateNestedManyWithoutManifestInput> =
  z.union([
    z.object({
      create: z
        .union([
...
export const SectionUncheckedCreateNestedManyWithoutManifestInputObjectSchema =
  Schema;
