...
export const manifestupdatesRouter = createRouter()
  ...
  .query("aggregateManifestUpdate", {
    ...
    async resolve({ ctx, input }) {
      const aggregateManifestUpdate = await ctx.prisma.manifestUpdate.aggregate(input);
  ...
  .mutation("createOneManifestUpdate", {
    ...
    async resolve({ ctx, input }) {
      const createOneManifestUpdate = await ctx.prisma.manifestUpdate.create({ data: input.data });
  ...
  .mutation("deleteManyManifestUpdate", {
    ...
    async resolve({ ctx, input }) {
      const deleteManyManifestUpdate = await ctx.prisma.manifestUpdate.deleteMany(input);
  ...
  .mutation("deleteOneManifestUpdate", {
    ...
    async resolve({ ctx, input }) {
      const deleteOneManifestUpdate = await ctx.prisma.manifestUpdate.delete({ where: input.where });
  ...
  .query("findFirstManifestUpdate", {
    ...
    async resolve({ ctx, input }) {
      const findFirstManifestUpdate = await ctx.prisma.manifestUpdate.findFirst(input);
  ...
  .query("findManyManifestUpdate", {
    ...
    async resolve({ ctx, input }) {
      const findManyManifestUpdate = await ctx.prisma.manifestUpdate.findMany(input);
  ...
  .query("findUniqueManifestUpdate", {
    ...
    async resolve({ ctx, input }) {
      const findUniqueManifestUpdate = await ctx.prisma.manifestUpdate.findUnique({ where: input.where });
  ...
  .query("groupByManifestUpdate", {
    ...
    async resolve({ ctx, input }) {
      const groupByManifestUpdate = await ctx.prisma.manifestUpdate.groupBy({ where: input.where, orderBy: input.orderBy, by: input.by, having: input.having, take: input.take, skip: input.skip });
  ...
  .mutation("updateManyManifestUpdate", {
    ...
    async resolve({ ctx, input }) {
      const updateManyManifestUpdate = await ctx.prisma.manifestUpdate.updateMany(input);
  ...
  .mutation("updateOneManifestUpdate", {
    ...
    async resolve({ ctx, input }) {
      const updateOneManifestUpdate = await ctx.prisma.manifestUpdate.update({ where: input.where, data: input.data });
  ...
  .mutation("upsertOneManifestUpdate", {
    ...
    async resolve({ ctx, input }) {
      const upsertOneManifestUpdate = await ctx.prisma.manifestUpdate.upsert({ where: input.where, create: input.create, update: input.update });
