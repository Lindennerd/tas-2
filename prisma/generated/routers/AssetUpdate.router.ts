...
export const assetupdatesRouter = createRouter()
  ...
  .query("aggregateAssetUpdate", {
    ...
    async resolve({ ctx, input }) {
      const aggregateAssetUpdate = await ctx.prisma.assetUpdate.aggregate(input);
  ...
  .mutation("createOneAssetUpdate", {
    ...
    async resolve({ ctx, input }) {
      const createOneAssetUpdate = await ctx.prisma.assetUpdate.create({ data: input.data });
  ...
  .mutation("deleteManyAssetUpdate", {
    ...
    async resolve({ ctx, input }) {
      const deleteManyAssetUpdate = await ctx.prisma.assetUpdate.deleteMany(input);
  ...
  .mutation("deleteOneAssetUpdate", {
    ...
    async resolve({ ctx, input }) {
      const deleteOneAssetUpdate = await ctx.prisma.assetUpdate.delete({ where: input.where });
  ...
  .query("findFirstAssetUpdate", {
    ...
    async resolve({ ctx, input }) {
      const findFirstAssetUpdate = await ctx.prisma.assetUpdate.findFirst(input);
  ...
  .query("findUniqueAssetUpdate", {
    ...
    async resolve({ ctx, input }) {
      const findUniqueAssetUpdate = await ctx.prisma.assetUpdate.findUnique({ where: input.where });
  ...
  .query("groupByAssetUpdate", {
    ...
    async resolve({ ctx, input }) {
      const groupByAssetUpdate = await ctx.prisma.assetUpdate.groupBy({ where: input.where, orderBy: input.orderBy, by: input.by, having: input.having, take: input.take, skip: input.skip });
  ...
  .mutation("updateManyAssetUpdate", {
    ...
    async resolve({ ctx, input }) {
      const updateManyAssetUpdate = await ctx.prisma.assetUpdate.updateMany(input);
  ...
  .mutation("updateOneAssetUpdate", {
    ...
    async resolve({ ctx, input }) {
      const updateOneAssetUpdate = await ctx.prisma.assetUpdate.update({ where: input.where, data: input.data });
  ...
  .mutation("upsertOneAssetUpdate", {
    ...
    async resolve({ ctx, input }) {
      const upsertOneAssetUpdate = await ctx.prisma.assetUpdate.upsert({ where: input.where, create: input.create, update: input.update });
