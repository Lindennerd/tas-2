...
export const commentsRouter = createRouter()
  ...
  .mutation("createOneComment", {
    ...
    async resolve({ ctx, input }) {
      const createOneComment = await ctx.prisma.comment.create({ data: input.data });
  ...
  .mutation("deleteOneComment", {
    ...
    async resolve({ ctx, input }) {
      const deleteOneComment = await ctx.prisma.comment.delete({ where: input.where });
  ...
  .query("findUniqueComment", {
    ...
    async resolve({ ctx, input }) {
      const findUniqueComment = await ctx.prisma.comment.findUnique({ where: input.where });
  ...
  .mutation("updateOneComment", {
    ...
    async resolve({ ctx, input }) {
      const updateOneComment = await ctx.prisma.comment.update({ where: input.where, data: input.data });
  ...
  .mutation("upsertOneComment", {
    ...
    async resolve({ ctx, input }) {
      const upsertOneComment = await ctx.prisma.comment.upsert({ where: input.where, create: input.create, update: input.update });
